(function () {
  ...
  function applyDarkMode(dark) {
    ...
    if (btnAll || btnPur) {
      if (dark) {
        if (btnAll) btnAll.style.cssText = 'padding:10px 22px !important;border-radius:10px !important;border:2px solid #7c6af7 !important;color:#fff !important;font-size:14px !important;font-weight:700 !important;cursor:pointer !important;font-family:inherit !important;';
        ...
        if (btnAll) btnAll.style.cssText = 'padding:10px 22px;border-radius:10px;border:2px solid #667eea;background:white;color:;font-size:14px;font-weight:700;cursor:pointer;font-family:inherit;';
